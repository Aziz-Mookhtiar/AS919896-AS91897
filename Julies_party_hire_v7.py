...
def entry_data():
    ...
    if first_name and last_name:
        ...
        receipt_window(first_name,last_name,item,amount)
...
def receipt_window():
    ...
    tk.Label(receipt_frame, text=f"First Name: {first_name_label}").pack(pady=10)
...
def hire_window():
    ...
    receipt_button = tk.Button(user_info_frame, text="Print Receipt", command=entry_data, padx=20, width=10)
