...
def quit_confirmation():
    ...
    quit_window.configure(bg="#FFA500")  

    quit_frame = tk.Frame(quit_window, bg="#FFA500")  
    quit_frame.pack()

    confirmation = tk.Label(quit_frame, text="Are you sure you want to quit?", fg='#C21E56', bg="#FFA500")  
    ...
    button_styling = {"bg": "#afeeee", "fg": "#C21E56", "activebackground": "#7fffd4", "activeforeground": "#008b8b",
...
def display_receipt(receipt_number, first_name, last_name, item, amount):
    ...
    receipt_window.configure(bg='#FFA500')  

    receipt_frame = tk.Frame(receipt_window, bg='#FFA500')  
    receipt_frame.pack(padx=20, pady=20)

    tk.Label(receipt_frame, text=f"Receipt Number: {receipt_number}", fg='#C21E56', bg='#FFA500').pack(pady=5)  
    tk.Label(receipt_frame, text=f"First Name: {first_name}", fg='#C21E56', bg='#FFA500').pack(pady=5)  
    tk.Label(receipt_frame, text=f"Last Name: {last_name}", fg='#C21E56', bg='#FFA500').pack(pady=5)  
    tk.Label(receipt_frame, text=f"Item Chosen: {item}", fg='#C21E56', bg='#FFA500').pack(pady=5)  
    tk.Label(receipt_frame, text=f"Amount: {amount}", fg='#C21E56', bg='#FFA500').pack(pady=5)  
...
def hire_window():
    ...
    hire_window.configure(bg='#FFA500')  
    button_styling = {"bg": "#afeeee", "fg": "#C21E56", "activebackground": "#7fffd4", "activeforeground": "#008b8b",
                      "font": ("Comic Sans MS", 10, "bold")}

    text_styling = {"bg": "#FFA500", "fg": "#C21E56", "font": ("Comic San MS", 12, "bold")}  
    ...
    user_info_frame = tk.LabelFrame(hire_frame, text="Hire Information", padx=80, pady=80, fg="#C21E56", bg="#FFA500")  
...
def display_hired_items():
    ...
    display_window.configure(bg='#FFA500')  
    display_window.geometry("900x290")

    display_frame = tk.Frame(display_window, bg='#FFA500')  
    ...
    for item in hired_items:
        tk.Label(display_frame,
                 ...
                 fg='#C21E56', bg='#FFA500').pack(pady=5)  
...
def refund_section():
    ...
    refund_window.configure(bg='#FFA500')  

    refund_frame = tk.Frame(refund_window)
    refund_frame.pack()

    refund_info_frame = tk.LabelFrame(refund_frame, text="Refund Information", padx=80, pady=80, bg='#FFA500', fg="#C21E56")  
...
main_window.configure(bg='#FFA500')  
